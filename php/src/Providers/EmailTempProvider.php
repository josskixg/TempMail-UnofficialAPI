...
class EmailTempProvider implements TempMailProvider
{
    private const BASE_URL = 'https://email-temp.com';
    private const COOKIE_DOMAIN = '.email-temp.com';
    private const SITE_NAME = 'email-temp';
